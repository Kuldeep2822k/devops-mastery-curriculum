---
title: '30-Day Boot (Survival Path)'
tags:
  - schedule
  - progress
---

# 30-Day Boot (Survival Path)

## How to Use

- Treat each day/week as a repetition cycle: learn → lab → write → review.
- Capture evidence artifacts (runbook/ADR/exam outputs).
- If you slip, keep the order; do not skip verification and cleanup.
